...
#ifndef WEBSPATIALTEST_SWIFT_H
#define WEBSPATIALTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WebSpatialTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14WebSpatialTest11AppDelegate")
...
@class UIScrollView;
@class NSString;
SWIFT_CLASS("_TtC14WebSpatialTest11Coordinator")
@interface Coordinator : NSObject <UIScrollViewDelegate, WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate, WKURLSchemeHandler>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
- (void)webView:(WKWebView * _Nonnull)webView didStartProvisionalNavigation:(WKNavigation * _Null_unspecified)didStartProvisionalNavigation;
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC14WebSpatialTest13SceneDelegate")
